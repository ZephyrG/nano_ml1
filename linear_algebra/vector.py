...
class Vector(object):
    ...
    ONLY_DEFINED_IN_TWO_THREE_DIMS_MSG = 'Only defined in two and three dimensions'
    ...
    def __next__(self): # for python 3, if p2 next(self)
       self.idx += 1
       try:
    ...
    def area_of_triangle_with(self, v):
        ...
        return cross_product.magnitude() / Decimal('2.0')
